...
import { Star, MessageSquare, Award, Target, TrendingUp, Users, Filter, Search } from 'lucide-react'
...
const RecruiterScorecard: React.FC = () => {
  ...
  const recruiters: RecruiterRating[] = [
    {
      id: '1',
      recruiterName: 'Sarah Johnson',
      recruiterEmail: 'sarah.johnson@techcorp.co.za',
      totalReviews: 47,
      ...
      recentFeedback: [
        {
          ...
          rating: 5,
          feedback: 'Excellent communication throughout the process. Very professional and transparent about the role.',
          date: '2024-01-10'
        }
      ]
    },
    {
      ...
      recruiterEmail: 'michael.chen@fintech.co.za',
      totalReviews: 23,
      avgCommunication: 3.8,
      avgProfessionalism: 4.2,
      avgRoleAccuracy: 3.6,
      overallRating: 3.9,
      positiveReviews: 15,
      negativeReviews: 5,
      recentFeedback: [
        {
          ...
          rating: 2,
          feedback: 'Role description did not match actual requirements. Poor communication after initial contact.',
          date: '2024-01-08'
        }
      ]
    }
