/*
  # Create interviews table for scheduling functionality
  ...
  2. Security
    ...
    - Add policies for viewing interview details

  3. Indexes
    - Index on recruiter_id for efficient queries
    - Index on scheduled_at for date-based filtering
    - Index on status for filtering by interview status
*/
