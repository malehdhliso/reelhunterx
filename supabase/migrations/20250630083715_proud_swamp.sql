...
-- Recreate the view with skills-first approach and new column structure
...
SELECT 
  ...
  -- Count verifications by type (reordered by importance - skills first)
...
'Comprehensive SA ReelPass status view prioritizing verified skills over traditional credentials. Reflects the platform philosophy of valuing practical demonstration over paper qualifications.';